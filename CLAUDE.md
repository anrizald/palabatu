...
- Numbering is at `0022` as of 2026-09-17: `0014`/`0015` the crags/boulders/problems hierarchy, `0016` add-flow v2, `0017` approach guides, `0018` feedback type, `0020` `boulders.filed_uncertain`, `0021` `photo_credits` (see `internal/photocredits` in the Architecture tree), `0022` add-sheet drafts (see `internal/drafts`).
