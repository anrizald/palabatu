...
import { Map as MapIcon, Users, User, LogIn, UserPlus, LogOut, Flag, Bell, Wrench, MessageSquare, X, GitCompare, HelpCircle } from 'lucide-react';
                    ...
                    <>
                        ...
                        >
                            ...
                            <nav className="sidebar-nav">
                                ...
                                {isAdmin && (
                                    <Link to="/admin/needs-attention" className="sidebar-item" onClick={onClose}>
                                        <HelpCircle size={18} /> Rocks to tidy
                                    </Link>
                                )}
                                {isOwner && (
