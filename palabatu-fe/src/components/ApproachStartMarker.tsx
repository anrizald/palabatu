...
import { buildTeardropIcon } from '../lib/mapIcons.js'
...
// rather than "this is a rock to climb".
const ICON = buildTeardropIcon({ ringColor: '#5dbb6a', size: 22, className: 'approach-start-icon' })
